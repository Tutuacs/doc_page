                    ...
                    <div className="bg-secondary flex flex-col p-4 lg:p-0 gap-2 lg:gap-4 w-full lg:w-1/2 h-full justify-center rounded-b-xl lg:rounded-r-xl lg:rounded-bl-none">
                        <div className="mx-auto">
                            ...
                            <div className="mt-4 text-center flex gap-8 justify-center">
                                ...
                                { /* Instagram */}
                                <Link href="https://www.instagram.com/dr.julianomachado?igsh=MWpuZWFwZWNxemVvdg%3D%3D&utm_source=qr" className="hover:animate-pulse">
                                    <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                { /* Youtube */}
                                <Link href="https://www.youtube.com/@dr.julianomachado" className="hover:animate-pulse">
                                    <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
