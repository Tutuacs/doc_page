...
export default function PainBody() {
    ...
    return (
        <div className="lg:h-[600px] h-[600px] w-full bg-quaternary my-auto flex flex-col items-center relative">
            <h1 className="my-8 text-2xl text-[#009687] font-bold">Selecione a área da sua dor:</h1>
            <div className="human-body bg-quaternary">
                <svg
                    data-position="head"
                    className="head"
                    ...
                    onClick={() => handleAreaClick("Cabeça")}
                >
