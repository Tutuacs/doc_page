    ...
    return (
        <main>
            <div className="bg-primary text-white min-h-96">
                <div className="flex items-center mx-auto h-60 w-[60%] rounded-lg">
                    <div className="bg-tertiary flex flex-col h-full w-1/2 mt-[-100] justify-center rounded-l-xl">
                        <div className="mx-auto">
                            <div className="text-3xl text-[#EEEEEE] font-bold text-center">Agende sua consulta</div>
                            <div className="mt-4 text-center">
                                <a href="https://wa.me/+5554996601120" target="_blank" className="flex gap-3 justify-center text-center border-2 py-4 px-2 rounded-lg  border-secondary hover:border-[#033147e3] hover:text-[#033147e3] transition-colors text-white">
                    ...
                    <div className="bg-secondary flex flex-col gap-4 w-1/2 h-full mt-[-100] justify-center rounded-r-xl">
                        <div className="mx-auto">
            ...
            <div className="bg-[#012230e3] text-slate-300 py-2 min-h-8 flex justify-between items-center italic text-sm">
                ...
                <div className="mr-[20%] mt-1">Desenvolvido por <span className="font-bold">Arthur Silva</span>.</div>
            </div>
        </main>
    )
}